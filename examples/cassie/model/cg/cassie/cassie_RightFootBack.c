...
#else
  #define CASADI_PREFIX(ID) cassie_RightFootBack_ ## ID
#endif
...
/* cassie_RightFootBack:(i0[23],i1[22])->(o0[3],o1[3x22],o2[3]) */
...
CASADI_SYMBOL_EXPORT int cassie_RightFootBack(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int cassie_RightFootBack_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int cassie_RightFootBack_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void cassie_RightFootBack_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int cassie_RightFootBack_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void cassie_RightFootBack_release(int mem) {
}

CASADI_SYMBOL_EXPORT void cassie_RightFootBack_incref(void) {
}

CASADI_SYMBOL_EXPORT void cassie_RightFootBack_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int cassie_RightFootBack_n_in(void) { return 2;}

CASADI_SYMBOL_EXPORT casadi_int cassie_RightFootBack_n_out(void) { return 3;}

CASADI_SYMBOL_EXPORT casadi_real cassie_RightFootBack_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* cassie_RightFootBack_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const char* cassie_RightFootBack_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    case 2: return "o2";
...
CASADI_SYMBOL_EXPORT const casadi_int* cassie_RightFootBack_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* cassie_RightFootBack_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int cassie_RightFootBack_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 2;
  if (sz_res) *sz_res = 3;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
