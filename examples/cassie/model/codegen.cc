...
int main(int argc, char* argv[]) {
    ...
    for (BodySite& site : contact_locations) {
        ...
        ADData::Vector3 dJdt_v = dJdt.topRows(3) * v_ad;
        ...
        pinocchio::casadi::copy(dJdt.topRows(3), cs_dJdt_v);
        cs_J = casadi::SX::densify(cs_J);
        cs_dJdt_v = casadi::SX::densify(cs_dJdt_v);

        casadi::Function fp(model.name + "_" + site.name,
                            casadi::SXVector{cs_q, cs_v},
                            casadi::SXVector{cs_p, cs_J, cs_dJdt_v});
    ...
    casadi::SX M, h, B, x_com, J_com, dJdt_v_com;
    ...
    pinocchio::casadi::copy(ad_data.acom[0], dJdt_v_com);
    ...
    std::vector<casadi::Function> functions{
        ...
        casadi::Function(model.name + "_centre_of_mass", casadi::SXVector{cs_q, cs_v}, casadi::SXVector{x_com, densify(J_com), dJdt_v_com})};
